...
function pregunta2()
{
  ...
  if(answer===false)
  {
    r2 = "Ensaladas/Pollo a la plancha";
    r=r+2;
  }
  if(answer===true)
  {
...
function pregunta4()
{
  ...
  alert(r);
  if (r>0 && r<8) {
    document.getElementById("ask").innerHTML ="Resultado: \nFelicitaciones! Eres una persona muy saludable.";
  } else {
    document.getElementById("ask").innerHTML ="Resultado: \nCuidado! Tu salud puede estar en riesgo, trata de llevar una vida saludable.";
  }
}
